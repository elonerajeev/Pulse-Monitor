...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hello {{userName}},</p>
      <p>This is an alert that your website <strong>{{serviceName}}</strong> is currently experiencing somethings Different Status Code. We were unable to reach your site as expected.</p>
